...
const supabaseUrl = (import.meta as any).env?.VITE_SUPABASE_URL || 'https://wfltyhnqvzeshcsfyoai.supabase.co';
const supabaseAnonKey = (import.meta as any).env?.VITE_SUPABASE_ANON_KEY || 'sb_publishable_KWoxrPYFFAEvUVQXNsGj8g_StXYwLOl';
